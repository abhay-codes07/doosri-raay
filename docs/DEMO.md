...
| 2 | 0:18–0:33 | Parent tile | Left pane: Papa's Panchang tile: tithi and date, weather, "Amlodipine 08:00 · Metformin 20:00", the photo card (placeholder unless `photoKey` was set on the profile). Cursor opens it once. | "Papa opens this every morning for the tithi and his medicines. Opening it is the check-in. Nothing else is asked of him, ever." | **Amplify Hosting**: URL visible in the address bar. |
